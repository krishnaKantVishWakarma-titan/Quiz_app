<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT `name`, `password` FROM `adminlogin` WHERE name='$myEmail' and password='$mypassword'";
...
<body>
    <header class="header">
        <div class="main-container">
            <form action="AdminLogin.php" method="post" name="Log_form" onsubmit="return validate()">
