<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT `email`, `password` FROM `teacherlogin` WHERE email='$myEmail' and password='$mypassword'";
...
<body>
    <header class="header">
        <div class="main-container">
            <form action="teacherLogin.php" method="post" name="Log_form" onsubmit="return validate()">
                ...
                <a href="teacherRegis.php">Register</a>
            </form>
        </div>
    </header>
